...
public class EditOfferFormValidator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return EditOfferForm.class.isAssignableFrom(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {
        EditOfferForm editOfferForm = (EditOfferForm) target;

        validateNameString(editOfferForm.getName(), errors);
        validateCategories(editOfferForm.getCategories(), errors);
        validateCountryString(editOfferForm.getCountry(), errors);
        validateCityString(editOfferForm.getCity(), errors);
        validateDescriptionString(editOfferForm.getDescription(), errors);
        validateAvailableFrom(editOfferForm.getAvailableFrom(), errors);
        validateAvailableTo(editOfferForm.getAvailableTo(), errors);
        validateDates(editOfferForm.getAvailableFrom(), editOfferForm.getAvailableTo(), errors);
        validateMinNumberOfPersons(editOfferForm.getMinNumberOfUsers(), errors);
        validateMaxNumberOfPersons(editOfferForm.getMaxNumberOfUsers(), errors);
        validatePricePerPerson(editOfferForm.getPricePerPerson(), errors);
    }
